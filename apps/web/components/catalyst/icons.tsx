...
/** Heroicons `chevron-down`, mini. Shared by Select and MultiSelect. */
...
/** Heroicons `minus`, mini — used for interrupted stage runs. */
...
/** Hollow circle — the "not started yet" pipeline marker. */
export function CircleOutlineIcon({ className }: { className?: string }) {
  return (
    <svg viewBox="0 0 20 20" fill="none" aria-hidden="true" className={clsx("size-4", className)}>
